...
El uso de las tecnologísa de información es omniprescente en cadá ámbito de la vida cotidiana, y se implementa en toda las industrias en mayor o menor medida. Hoy en día, bajo el desarrollo de nuevas tecnologías como la inteligencia artificial, este uso se masifica cada vez más, y contra lo que pueda suponerse, se requerirá cada vez más, nuevos especialistas en tecnologías de la información. Con la capacidad de diseñar y desarrollar soluciones.

Ese manual es un apoyo a la formación en el área de informática, consistente en una recopilación de contenidos apropiados, depurados y editados para su mejor comprensión. Se han añadido ejemplos probados, en cuanto a códigos de programación y otros, así como esquemas o diagramas aclaratorios. Basados en las clases ofrecidas tanto a nivel de educación superior como en Bootcamps y cursos de formación.
